<%@ Page Title="" Language="C#" MasterPageFile="~/bs.Master" AutoEventWireup="true" CodeBehind="Tsm-Plan-Onay.aspx.cs" Inherits="deneme9.Tsm_Plan_Onay" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function Tabloyu_Doldur() {
                ...
                $.ajax({
                    url: 'Tsm-Plan-Onay.aspx/Ziy_Onay_Tablo_Doldur',
                    type: 'POST',
                    data: "{'Şehir_Id': ''}",
                    async: false,
                    dataType: "json",
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < parsdata.length; i++) {
                            Tbody.append(
                                '<tr><td>' + parsdata[i].Ad + ' ' + parsdata[i].Soyad + '</td>' +
                                '<td>' + parsdata[i].Bas_Tar + '</td>' +
                                '<td>' + parsdata[i].Bit_Tar + '</td>' +
                                '<td>' + parsdata[i].Ziy_Dok + '</td>' +
                                '<td>' + parsdata[i].Ziy_Ecz + '</td>' +

                                '<td><a style="font-size: 20px; " id="Numune_Talebi_Kaldır" value="' + parsdata[i].Ziy_Onay_Id + '"><i class="fa fa fa-search"></i></a></td>' +
                                '</tr>'
                            )
                        }
            ...
            Onay_Talebi_Gonder_Modal.click(function () {
                $.ajax({
                    url: 'Tsm-Plan-Onay.aspx/Talebi_Onayla',
                    dataType: 'json',
                    type: 'POST',
