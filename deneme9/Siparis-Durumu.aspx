<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Siparis-Durumu.aspx.cs" Inherits="deneme9.Siparis_Durumu" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function Tablo_Listesini_Doldur() {
                ...
                $.ajax({
                    url: 'Siparis-Durumu.aspx/Tablo_Verisi',
                    type: 'POST',
            ...
            function Tabloyu_Doldur(Liste_) {
                ...
                if (Liste_.length > 0) {
                    ...
                    for (var i = 0; i < Liste_.length; i++) {
                        ...
                        Tbody.append(
                            '<tr><td>' + Liste_[i].Eczane_Adı + '</td>' +
                            '<td>' + Liste_[i].Şehir + '</td>' +
                            '<td>' + Liste_[i].Brick + '</td>' +
                            '<td>' + Liste_[i].Tar + '</td>' +
                            '<td>' + Onay_Label + '</td>' +

                            '<td>' + '<a value="' + Liste_[i].Sil + '" id="Sipariş_Detay_Normal"><i class="fa fa fa-search"></i></a>' + '</td>' +
            ...
            //            Tabloyu_Doldur_Detay(Molad_Liste).then($('#Ziyaret_Modal').modal('show'))
            ...
            async function Tabloyu_Doldur_Detay(Liste_) {
                console.log(Liste_)
                $('#Tablo_Div_Siparişlerim_Detay_Normal').empty();
                $('#Tablo_Div_Siparişlerim_Detay_Normal').append('<table id="example_Detay_Normal" class="display" style="width: 100%">' +
                    '<thead>' +
                    '<tr>' +
                    '<th>Urun Adı</th>' +
                    '<th>Adet</th>' +
                ...
                if (Liste_.length > 0) {
                    var Tbody = $('tbody[id=Tbody_Detay_Normal]')
                ...
                $('#example_Detay_Normal').dataTable({
            ...
            var Sipariş_Detay = $('a[id=Sipariş_Detay_Normal]')
            Sipariş_Detay.click(function () {
            ...
            <div class="modal-dialog vertical-align-center">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Siparişi Sil</h4>

                    </div>
                    <div class="modal-body">
                        Siparişi Silme Talebi Göndermek İstediğinizden Eminmisiniz ?

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kapat</button>
                        <button type="button" id="Siparişi_İptal_Talebi_Olustur" class="btn btn-primary">Sipariş Silme Talebi Gönder</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div id="Modal_Body" class="modal-body">
                    <div class="row">
                        <div id="Tablo_Div_Siparişlerim_Detay_Normal" class="col-xs-12">
                        </div>
                    </div>
                 <div class="row">
                            <div class="col-xs-12" style="padding-top:40px;">
                                   <textarea class="form-control" rows="4" id="Sipariş_Onay_Notu" placeholder="Sipariş Notu" disabled></textarea>
                            </div>
                        </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab_1" data-toggle="tab" aria-expanded="false">Siparişlerim
                        </a>
                    </li>
                    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="true">Onaylanan Siparişlerim</a></li>
                    <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Reddedilen Siparişlerim</a></li>
                </ul>
