<%@ Page Title="" Language="C#" MasterPageFile="~/KMY.Master" AutoEventWireup="true" CodeBehind="Sipariş_Rapor_KMY.aspx.cs" Inherits="deneme9.Sipariş_Rapor_KMY" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: 'Sipariş_Rapor_KMY.aspx/Kullanıcı_Listesi',
                type: 'POST',
                data: "{'Şehir_Id': ''}",
                async: false,
                dataType: "json",
