<%@ Page Title="" Language="C#" MasterPageFile="~/Dp.Master" AutoEventWireup="true" CodeBehind="Numune-Talep-Onay.aspx.cs" Inherits="deneme9.Numune_Talep_Onay" %>
   ...
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           function Tablo_Listesini_Doldur() {
               $.ajax({
                   url: 'Numune-Talep-Onay.aspx/Tablo_Verisi',
                   type: 'POST',
                   ...
                   success: function (data) {
                       ...
                       for (var i = 0; i < temp.length; i++) {
                           ...
                           MyClass.UrunADI = temp[i].UrunADI
                           MyClass.Adet = temp[i].Adet
                           MyClass.Numune_Talebi_Id = temp[i].Numune_Talebi_Id
               ...
               if (Liste_.length > 0) {
                   ...
                   for (var i = 0; i < Liste_.length; i++) {
                       ...
                       Tbody.append(
                           ...
                           '<td>' + Liste_[i].UrunADI + '</td>' +
                           '<td>' + Liste_[i].Adet + '</td>' +
                           '<td>' + Onay_Label + '</td>' +

                           '<td>' + '<a value="' + Liste_[i].Numune_Talebi_Id + '" id="Sipariş_Detay"><i class="fa fa fa-search"></i></a>' + '</td>' +
           ...
           Ziyaret_Modal_Red.click(function () {
               ...
               $.ajax({
                   url: 'Numune-Talep-Onay.aspx/Onay_Durumu_Güncelle',
                   type: 'POST',
