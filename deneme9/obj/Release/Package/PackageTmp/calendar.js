...
//var cal = {
//    // (A) PROPERTIES
//    mName: ["Ocak", "Subat", "Mart", "Nisan", "Mayis", "Haziran", "Temmuz", "Agustos", "Eylul", "Ekim", "Kasim", "Aralik"], // Month Names
...
//        div_1.className = "col-lg-12 ";
//        var div_2 = document.createElement("div");
//        div_2.className = "box box-default collapsed-box box-solid";
...
window.addEventListener("load", function () {
    ...
    //var box_Eczaneler = document.createElement("div");
    //box_body_Eczaneler.setAttribute("style", "display: none;");
    //box_Eczaneler.className = "box-body";
    //box_body_Eczaneler.appendChild(box_Eczaneler);
    //box_Eczaneler.innerHTML += "asdsad";
