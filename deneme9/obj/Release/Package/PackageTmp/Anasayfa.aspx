<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="deneme9.Anasayfa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var Sipariş_H3 = $('h3[id=Sipariş_H3]')
            var Eczane_H3 = $('h3[id=Eczane_H3]')
            var Doktor_H3 = $('h3[id=Doktor_H3]')

            $.ajax({
                url: 'Anasayfa.aspx/Bastakileri_Doldur',
                type: 'POST',
                data: "{'parametre': ''}",
                async: false,
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    Sipariş_H3.html(temp[0].Siparis_Sayısı)
                    Eczane_H3.html(temp[0].Eczane)
                    Doktor_H3.html(temp[0].Doktor)
            ...
            var Eczane_Data = [];
            $.ajax({
                url: 'Anasayfa.aspx/Ziyaret_Grafik_Doldur',
                type: 'POST',
                data: "{'parametre': ''}",
                async: false,
                dataType: "json",
            ...
            var Adet_Data = [];
            $.ajax({
                url: 'Anasayfa.aspx/Adet_Tablo_Doldur',
                type: 'POST',
                data: "{'parametre': ''}",
                async: false,
                dataType: "json",
            ...
            var Ciro_Data = [];
            $.ajax({
                url: 'Anasayfa.aspx/Ciro_Tablo_Doldur',
                type: 'POST',
                data: "{'parametre': ''}",
                async: false,
                dataType: "json",
                ...
                buttons: [

                    {
                        ...
                        customize: function (doc) {
                            ...
                            $.ajax({
                                url: 'Anasayfa.aspx/Sınav_Detay_Getir',
                                type: 'POST',
                                data: "{'Sınav_Id': ' '}",
                                async: false,
                                dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-4 col-xs-4">
            <!-- small box -->
            <div class="small-box bg-aqua" style="background-color: #39cccc !important">
                <div class="inner">
                    <h3 id="Sipariş_H3"></h3>

                    <p>Bu Ay Onaylanan Sipariş Sayısı</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-xs-4">
            ...
            <div class="small-box bg-aqua" style="background-color: #39cccc !important">
                <div class="inner">
                    ...
                    <p>Bu Ay Ziyaret Ettiğin Toplam Eczane</p>
                </div>
                <div class="icon">
                    <i class="ion ion-pie-graph"></i>
                </div>
        ...
        <div class="col-lg-4 col-xs-4">
            ...
            <div class="small-box bg-aqua" style="background-color: #39cccc !important">
                <div class="inner">
                    ...
                    <p>Bu Ay Ziyaret Ettiğin Toplam Doktor</p>
                </div>
                <div class="icon">
                    <i class="ion ion-pie-graph"></i>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header with-border">
                    <i class="fa fa-bar-chart-o"></i>
                    <h3 class="box-title">Kota Realizasyon</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse">
                            <i class="fa fa-minus"></i>
                        </button>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Son Açıklanan Sınavın Sonuçları</h3>
