<%@ Page Title="" Language="C#" MasterPageFile="~/bs.Master" AutoEventWireup="true" CodeBehind="Tsm-Plan-Raporu.aspx.cs" Inherits="deneme9.Tsm_Plan_Raporu" %>
        ...
        $(document).ready(function () {
            ...
            cal_set.on('click', function () {
                if (Tsm_Ad.find('option:selected').val() != 0) {
                    window.location.href = "Tsm-Plan-Raporu.aspx?x=" + TextBox2.val() + "&y=" + TextBox3.val() + "&z=" + Tsm_Ad.find('option:selected').val()
                }
                else {
            ...
            var parsdata;
            $.ajax({
                url: 'Tsm-Plan-Raporu.aspx/Ziyaret_Edilecekler',
                dataType: 'json',
                type: 'POST',
                async: false,
            ...
            $.ajax({
                url: 'Tsm-Plan-Raporu.aspx/Tabloları_Doldur_Eczane',
                dataType: 'json',
                type: 'POST',
                data: "{'parametre': '" + TextBox2.val() + "*" + TextBox3.val() + "*" + Kullanıcı + "'}",
                contentType: 'application/json; charset=utf-8',
