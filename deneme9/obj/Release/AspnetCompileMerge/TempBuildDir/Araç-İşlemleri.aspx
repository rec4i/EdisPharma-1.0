<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="Araç-İşlemleri.aspx.cs" Inherits="deneme9.Araç_Lastik_Değişimi" %>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false">Araç Lastik Değişimi </a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <div class="row">
                            <div class="col-xs-12">
                                <label>Tahmini Lastik Değişim Kilometresi(km) : </label>
                                <div class="form-group">
                                    <input id="Tahmini_Lastik_Kilometresi" class="form-control" placeholder="30000" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <label>Araç Lasit Fotoğrafları(Takılı 4 Yeni Lastik):</label>
                                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                <input id="Lastik_değişimi_Oluştur" class="btn btn-block btn-primary" type="button" value="Oluştur" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
