<%@ Page Title="" Language="C#" MasterPageFile="~/Dp.Master" AutoEventWireup="true" CodeBehind="Meteryal-Talebi-Onay.aspx.cs" Inherits="deneme9.Meteryal_Talebi_Onay" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function Tablo_Listesini_Doldur_Red() {
                $.ajax({
                    url: 'Meteryal-Talebi-Onay.aspx/Tablo_Verisi_Red',
                    type: 'POST',
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < temp.length; i++) {
                            ...
                            var MyClass = {
                                ...
                                Tar: null,
                                Onay_Durum: null,
                                Materyal_Talep_Genel_Id: null,
                              

                            }

                            MyClass.Kullanıcı_Ad = temp[i].Kullanıcı_Ad
                            MyClass.Tar = temp[i].Tar
                            MyClass.Onay_Durum = temp[i].Onay_Durum
                            MyClass.Materyal_Talep_Genel_Id = temp[i].Materyal_Talep_Genel_Id
            ...
            function Tablo_Listesini_Doldur_Onaylanan() {
                $.ajax({
                    url: 'Meteryal-Talebi-Onay.aspx/Tablo_Verisi_Onaylanan',
                    type: 'POST',
            ...
            function Tablo_Listesini_Doldur() {
                $.ajax({
                    url: 'Meteryal-Talebi-Onay.aspx/Tablo_Verisi',
                    type: 'POST',
            ...
            function Tabloyu_Doldur_Red(Liste_) {
                ...
                if (Liste_.length > 0) {
                    ...
                    for (var i = 0; i < Liste_.length; i++) {
                        ...
                        Tbody.append(
                            '<tr>' +
                            '<td>' + Liste_[i].Kullanıcı_Ad + '</td>' +
                            '<td>' + Liste_[i].Tar + '</td>' +
                            '<td>' + Onay_Label + '</td>' +
                            '<td>' + '<a value="' + Liste_[i].Materyal_Talep_Genel_Id + '" id="Sipariş_Detay"><i class="fa fa fa-search"></i></a>' + '</td>' +
            ...
            function Tabloyu_Doldur_Detay(Liste_) {
                ...
                if (Liste_.length > 0) {
                    ...
                    for (var i = 0; i < Liste_.length; i++) {
                        Tbody.append(
                            '<tr>' +
                            '<td>' + Liste_[i].Materyal_Talebi_Tip_txt + '</td>' +
                            '<td>' + Liste_[i].Urun + '</td>' +
                            '<td>' + Liste_[i].Adet + '</td>' +
            ...
            Sipariş_Detay.click(function () {
                ...
                $.ajax({
                    url: 'Meteryal-Talebi-Onay.aspx/Sipariş_Detay',
                    type: 'POST',
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < temp.length; i++) {
                            ...
                            var MyClass = {
                                Materyal_Talep_Detay_Id: null,
                                Materyal_Talep_Genel_Id: null,
                                Materyal_Talebi_Tip_txt: null,
                                Urun: null,
                                Adet: null,

                            }

                            MyClass.Materyal_Talep_Detay_Id = temp[i].Materyal_Talep_Detay_Id
                            MyClass.Materyal_Talep_Genel_Id = temp[i].Materyal_Talep_Genel_Id
                            MyClass.Materyal_Talebi_Tip_txt = temp[i].Materyal_Talebi_Tip_txt
                            MyClass.Urun = temp[i].Urun
            ...
            Ziyaret_Modal_Onay.click(function () {
                İşlem_Mesajı.append('Sipariş Onaylandı Olarak Kaydedilecek!')
                $('div[id=myModal]').modal('show')
                var Siparişi_İptal_Talebi_Olustur = $('button[id=Siparişi_İptal_Talebi_Olustur]')
                ...
                Siparişi_İptal_Talebi_Olustur.attr('value', $(this).attr('value'))
                Siparişi_İptal_Talebi_Olustur.empty();
                Siparişi_İptal_Talebi_Olustur.append('Onayla')
            });

            var Siparişi_İptal_Talebi_Olustur = $('button[id=Siparişi_İptal_Talebi_Olustur]')
            Siparişi_İptal_Talebi_Olustur.click(function () {
                if ($(this).attr('islem')=="0") {
                    $.ajax({
                        url: 'Meteryal-Talebi-Onay.aspx/Onay_Durumu_Güncelle',
                        type: 'POST',
                        data: "{'Sipariş_Id': '" + $(this).attr("value") + "','islem':'2'}",
                        async: false,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            ...
                            window.location.assign("/Meteryal-Talebi-Onay.aspx")
                ...
                if ($(this).attr('islem') == "1") {
                    $.ajax({
                        url: 'Meteryal-Talebi-Onay.aspx/Onay_Durumu_Güncelle',
                        type: 'POST',
                        data: "{'Sipariş_Id': '" + $(this).attr("value") + "','islem':'1'}",
                        async: false,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            <div class="modal-dialog vertical-align-center">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Siparişi Onayla/Reddet</h4>

                    </div>
                    <div id="İşlem_Mesajı" class="modal-body">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="Ziyaret_Modal_Red" class="btn btn-danger" data-dismiss="modal">Siparişi Reddet</button>
                     <button type="button" id="Ziyaret_Modal_Onay" class="btn btn-info" data-dismiss="modal">Siparişi Onayla</button>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab_1" data-toggle="tab" aria-expanded="false">Talepler
                        </a>
                    </li>
                    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="true">Onaylanan Talepler</a></li>
                    <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Reddedilen Talepler</a></li>
                </ul>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-2 ">
                                            <div class="form-group">
                                                <input id="cal_set_Onaylanan" type="button" class="btn btn-block btn-info" value="SET" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div id="Tablo_Div_Siparişlerim_Onaylanan" class="col-xs-12">
                                    </div>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-2 ">
                                            <div class="form-group">
                                                <input id="cal_set_Reddedilen" type="button" class="btn btn-block btn-info" value="SET" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div id="Tablo_Div_Siparişlerim_red" class="col-xs-12">
                                    </div>
