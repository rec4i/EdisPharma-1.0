<%@ Page Title="" Language="C#" MasterPageFile="~/Bs.Master" AutoEventWireup="true" CodeBehind="Tsm-Masraf-Raporu.aspx.cs" Inherits="deneme9.Tsm_Masraf_Raporu" %>
        ...
        $(document).ready(function () {
            ...
            cal_set.on('click', function () {
                if (Tsm_Ad.find('option:selected').val() != 0) {
                    window.location.href = "Tsm-Masraf-Raporu.aspx?x=" + TextBox2.val() + "&y=" + TextBox3.val() + "&z=" + Tsm_Ad.find('option:selected').val()
                }
                else {
