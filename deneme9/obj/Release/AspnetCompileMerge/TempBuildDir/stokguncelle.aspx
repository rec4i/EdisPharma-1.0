<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="stokguncelle.aspx.cs" Inherits="deneme9.stokguncelle" %>
                    ...
                    <div class="col-lg-12">
                        <div class="box box-warning  collapsed-box box-solid">
                            ...
                            <div class="box-body">
                                ...
                                <asp:Label ID="LabelID" runat="server" Visible="false" Text='<%# Eval("UrunID") %>' CssClass="resimlbl"></asp:Label>
                                <div class="form-group">
                                   
                                    <asp:DropDownList ID="DropDownListadet" DataTextField="sayılartxt" AppendDataBoundItems="true" DataValueField="sayılar" CssClass="form-control" runat="server">
                                        <asp:ListItem Value="0">-- ADET SEÇ --</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div id="MFDİV" runat="server" class="form-group">
                                   
                                    <asp:DropDownList ID="DropDownListmf" DataTextField="sayılartxt" AppendDataBoundItems="true" DataValueField="sayılar" CssClass="form-control" runat="server">
            ...
            <div class="col-lg-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a style="font-size: 20px;"  href='stokguncelle.aspx?SiparişID=<%#Eval("SiparisID") %>&islem=sil&EczaneID=<%#Eval("EczaneID") %>'><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                        ...
                        <asp:Button ID="btn_siparisver" enableEventValidation="False" runat="server" CssClass="btn btn-block btn-primary" OnClick="btn_siparisver_Click" Text="Stoğu Güncelle" />
                        <!-- /.box -->
                    </div>
