<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="siparisonaylılar.aspx.cs" Inherits="deneme9.siparisonaylılar" %>
            ...
            <div class="col-lg-12">
                <div class="box box-info box-solid">
                    ...
                    <div class="box-body">
                       ...
                       <%-- <div class="box">
                            <div class="box-body">
                                <asp:TextBox ID="TextBox1" CssClass="col-lg-3" runat="server" Text="" TextMode="Date"></asp:TextBox>
                                <asp:TextBox ID="TextBox2"  CssClass="col-lg-3" runat="server" Text="" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>--%>
                        <div class="box">
                                        ...
                                        <asp:Repeater ID="RepeaterSiparisOnayDurum" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><a href='siparisonaylılar.aspx?EczaneID=<%#Eval("EczaneID") %>&siparisID=<%# Eval("SiparislerID") %>'><i class="fa fa fa-search"></i></a></td>
